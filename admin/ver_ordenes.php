...
<script language="javascript" type="text/javascript">
    ...
    popUpWin = open(URLStr,'popUpWin', 'toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=no,copyhistory=yes,width='+700+',height='+500+',left='+left+', top='+top+',screenX='+left+',screenY='+top+'');
    }
                                ...
                                <div class="table-responsive m-t-20">
                                    ...
                                    <div class="btnacciones">
                                        ...
                                        <a href="javascript:void(0);" onClick="popUpWindow('perfil_usuario.php?newform_id=<?php echo htmlentities($rows['o_id']);?>');" title="Update order">
                                            <button type="button" class="btn btn-primary">Detalles del usuario</button>
                                        </a>
                                    </div>
