                                            ...
                                            if (!mysqli_num_rows($query) > 0) {
                                                ...
                                                while ($rows = mysqli_fetch_array($query)) {
                                                    ...
                                                    echo '<tr>
                                                            ...
                                                            <td>
                                                                <a style="padding:5px 10px !important; width:100%; height:100%;" href="borrar_producto.php?pro_del=' . $rows['p_id'] . '" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
                                                                <a style="border-radius:2px !important; padding:7px 10px !important; width:100%; height:100%;" href="actualizar_producto.php?pro_upd=' . $rows['p_id'] . '" class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
                                                            </td>
                                                        </tr>';
                                                }
                                            }
