																	...
																	while($rows=mysqli_fetch_array($query))
																		{
																					...
																					echo ' <tr><td>'.$rows['nombre'].'</td>
																								...
																								<td>'.$rows['fecha'].'</td>
																								<td>
																									 <a style="padding:5px 10px !important; width:100%; height:100%;" href="borrar_admin.php?admin_del='.$rows['adm_id'].'" class="btn btn-danger btn-flat btn-addon btn-xs m-b-10"><i class="fa fa-trash-o" style="font-size:16px"></i></a> 
																									 <a style="border-radius:2px !important; padding:7px 10px !important; width:100%; height:100%;" href="actualizar_admin.php?admin_upd='.$rows['adm_id'].'" " class="btn btn-info btn-flat btn-addon btn-sm m-b-10 m-l-5"><i class="ti-settings"></i></a>
																								</td>
																							</tr>';
